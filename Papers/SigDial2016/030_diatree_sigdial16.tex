...
\begin{itemize}
 ...
 \item \texttt{confirm} -- act on the confirmation of the user; in effect, \texttt{select} the proposed slot value%the user has responded to the clarification request (which acts similar to a \texttt{select})
\end{itemize}
