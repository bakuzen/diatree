...
//	        		frame.setLocationRelativeTo(null);
				...
				private ButtonGroup getButtonGroup(String string, JFrame frame) {
					...
					JRadioButton phaseA = new JRadioButton("Phase 1");
					phaseA.setActionCommand("Phase1"+string);
					...
					JRadioButton phaseB = new JRadioButton("Phase 2");
					phaseB.setActionCommand("Phase2"+string);
