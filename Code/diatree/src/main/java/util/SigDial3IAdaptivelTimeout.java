...
public class SigDial3IAdaptivelTimeout extends Thread {
	
	
	private static SigDial3IAdaptivelTimeout timeoutThread;
...
//	singleton
	public static SigDial3IAdaptivelTimeout getInstance() {
		
		if (timeoutThread == null) {
			timeoutThread = new SigDial3IAdaptivelTimeout();
		}
	...
	private void display() {
		 EventQueue.invokeLater(new Runnable() {
	            ...
	            public void run() {
	        		...
	        		getButtonGroup(".p3q10", frame);		        		
	        		
	        		
	        		JLabel q11 = new JLabel();
	        		q11.setBorder(BorderFactory.createLineBorder(Color.BLACK));
	        		q11.setText("<html>Ich hatte das Gefühl, dass der Assistent <br>versuchte, etwas über mich zu lernen.</html>");
	        		frame.getContentPane().add(q11);
	        		getButtonGroup(".p3q11", frame);	 	 
	        		
	        		JLabel q12 = new JLabel();
	        		q12.setBorder(BorderFactory.createLineBorder(Color.BLACK));
	        		q12.setText("<html>Ich hatte das Gefühl, dass der Assistent<br> falsche Vorhersagen machte.</html>");
	        		frame.getContentPane().add(q12);
	        		getButtonGroup(".p3q12", frame);	        		
...
//	        		frame.setLocationRelativeTo(null);
				...
				private ButtonGroup getButtonGroup(String string, JFrame frame) {
					...
					JRadioButton phaseA = new JRadioButton("Phase 2");
					phaseA.setActionCommand("Phase2"+string);
					...
					JRadioButton phaseB = new JRadioButton("Phase 3");
					phaseB.setActionCommand("Phase3"+string);
